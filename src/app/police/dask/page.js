...
Vergi No: ${form.sirketMi === "Evet" ? form.vergiNo : "-"}
Şirket Ünvanı: ${form.sirketMi === "Evet" ? form.sirketUnvani : "-"}
    ...
    <div style={pageStyle}>
      ...
      <div style={outerWrapStyle}>
        <div style={leftCardStyle}>
          <div style={badgeTopStyle}>🏠 DASK teklif formu</div>
          ...
          <div style={gridStyle}>
            ...
            {renderInput("binaYili", "Bina Yapım Yılı", "Örn. 2015", "text")}
            {renderInput("katSayisi", "Kat Sayısı", "Örn. 8", "text")}

            <div style={isMobile ? { gridColumn: "auto" } : { gridColumn: "1 / -1" }}>
              {renderTextArea("adres", "Adres", "Mahalle / sokak / bina no")}
            </div>

            {renderInput("daireMetre", "Daire m²", "Örn. 120", "text")}
            {renderSelect("kullanimTipi", "Kullanım Tipi", [
              "",
              "Mesken",
              "Kiracı",
              "Ev Sahibi",
            ])}
            {renderSelect("hasarDurumu", "Hasar Durumu", [
              "",
              "Hasarsız",
              "Önceki hasar var",
            ])}

            {renderSelect("tapuDurumu", "Tapu Durumu", [
              "",
              "Kat mülkiyeti",
              "Kat irtifakı",
              "Diğer",
            ])}
            {renderSelect("sirketMi", "Şirket mi?", ["", "Evet", "Hayır"])}
